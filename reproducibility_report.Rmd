...
We identified `r pander(length(linked_to_asd))` genes that had been previously linked to ASD.
...
### 7. Protein-protein interactions (PPI) network analysis and vizualization.
