...
This is a reproducibility report for "Understanding the impact of SNPs associated with autism spectrum disorder on biological pathways in the human fetal and adult cortex" study published in [Scientific Reports](https://www.nature.com/articles/s41598-021-95447-z). 
...
df = data.frame("SNPs" = c("coding","non-coding"), "Percent" = c(exonic, 100 - exonic))
pie = ggplot(df, aes(x="", y=Percent, fill=SNPs)) + geom_bar(stat="identity", width=1)
